...
class User(TimestampMixin):
    ...
    username = fields.CharField(unique=True, null=True, max_length=20, description="用户名")
...
class Role(TimestampMixin):
    ...
    role_name = fields.CharField(unique=True, max_length=15, description="角色名称")
...
class Access(TimestampMixin):
    role: fields.ManyToManyRelation[Role]
    access_name = fields.CharField(unique=True, max_length=15, description="权限名称")
